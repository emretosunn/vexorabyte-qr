...
import { QrCode, Mail, Lock, ArrowRight, Eye, EyeOff, Loader2 } from "lucide-react";
                    ...
                    <form action={handleSubmit} className="space-y-5">
                        ...
                        <div>
                            <div className="flex items-center justify-between mb-2">
                                ...
                                <Link href="/auth/forgot-password" className="text-[12px] text-orange-500 hover:text-orange-600 transition-colors">
                                    Şifremi Unuttum
                                </Link>
                            </div>
                            <div className="relative">
