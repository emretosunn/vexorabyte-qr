                ...
                <div className="p-8 rounded-3xl bg-white dark:bg-white/[0.02] border border-slate-200 dark:border-white/5 shadow-xl dark:shadow-none">
                    <div className="text-center mb-8">
                        ...
                        <p className="text-[14px] text-slate-500 dark:text-white/40">
                            Dakikalar içinde menünüzü oluşturun
                        </p>
                    </div>
                    ...
                    <form action={handleSubmit} className="space-y-5">
                        ...
                        <div>
                            ...
                            <div className="relative">
                                <User className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-slate-400 dark:text-white/30" />
                                <input
                                    type="text"
                                    name="full_name"
                        ...
                        <div>
                            ...
                            <div className="relative">
                                <Lock className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-slate-400 dark:text-white/30" />
                                <input
                                    ...
                                    minLength={6}
                                    disabled={isPending}
                                    className="w-full pl-12 pr-12 py-3 rounded-xl bg-slate-50 dark:bg-white/5 border border-slate-200 dark:border-white/10 text-slate-900 dark:text-white text-[14px] placeholder:text-slate-400 dark:placeholder:text-white/30 focus:outline-none focus:ring-2 focus:ring-orange-500/30 focus:border-orange-400 dark:focus:border-orange-500/50 transition-all disabled:opacity-50"
                                />
                                <button
                                    type="button"
                        ...
                        <div className="p-4 rounded-xl bg-orange-50 dark:bg-orange-500/5 border border-orange-100 dark:border-orange-500/10">
                            <p className="text-[12px] font-medium text-orange-700 dark:text-orange-400 mb-3">Ucretsiz beta suresince:</p>
                            <ul className="space-y-2">
                                {["1 Restoran", "En fazla 15 kategori", "En fazla 100 urun", "QR Kod + PNG indirme", "Realtime menu guncelleme"].map((feature, i) => (
                                    <li key={i} className="flex items-center gap-2 text-[13px] text-orange-600 dark:text-orange-300/70">
                                        <Check className="w-4 h-4" />
                                        {feature}
                                    </li>
                                ))}
                            </ul>
                            <p className="mt-3 text-[12px] text-orange-700/80 dark:text-orange-300/80">
                                Premium (sinirsiz urun + sinirsiz kategori) icin WhatsApp uzerinden ulasabilirsiniz; onay sonrasi hesabiniza manuel tanimlanir.
                            </p>
                        </div>
                    ...
                    <div className="relative my-8">
                        ...
                        <div className="relative flex justify-center text-[12px]">
                            <span className="px-4 bg-white dark:bg-[#0a0a0d] text-slate-400 dark:text-white/30">
                                veya
                            </span>
                        </div>
                    </div>
                    ...
                    <button
                        ...
                        disabled={isPending}
                        className="w-full flex items-center justify-center gap-3 py-3 rounded-xl bg-slate-100 dark:bg-white/5 border border-slate-200 dark:border-white/10 text-slate-700 dark:text-white text-[14px] font-medium hover:bg-slate-200 dark:hover:bg-white/10 transition-colors disabled:opacity-50"
                    >
                    ...
                    {/* Login Link */}
                    <p className="text-center text-[14px] text-slate-500 dark:text-white/40 mt-8">
